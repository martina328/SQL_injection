...
INSERT INTO users (id, name, email, image_name, password, created_at, updated_at) VALUES(1,'Ken the Ninja','ninja@progate.com','/image/users/default_user.jpg','password','2021-04-18 08:06:52.739','2021-04-18 08:06:52.739');
-- UPDATE TEST USER
INSERT INTO users (id, name, email, image_name, password, created_at, updated_at) VALUES(2,'Master Wooly','master@progate.com','/image/users/2.jpg','password','2021-04-23 11:41:53.913','2021-04-23 11:41:53.913');
-- DELETE POST TEST USER
INSERT INTO users (id, name, email, image_name, password, created_at, updated_at) VALUES(3,'Ben the Baby Ninja','baby@progate.com','/image/users/3.jpg','password','2021-04-23 11:43:49.518','2021-04-23 11:43:49.518');
INSERT INTO users (id, name, email, image_name, password, created_at, updated_at) VALUES(4,'Mike','mike@progate.com','/image/users/4.jpg','password','2021-04-23 11:44:06.890','2021-04-23 11:44:06.890');
INSERT INTO users (id, name, email, image_name, password, created_at, updated_at) VALUES(5,'Kate','kate@progate.com','/image/users/5.jpg','password','2021-04-23 11:44:18.073','2021-04-23 11:44:18.073');
INSERT INTO users (id, name, email, image_name, password, created_at, updated_at) VALUES(6,'for user show','6@progate.com','/image/users/default_user.jpg','password','2021-04-23 11:44:18.073','2021-04-23 11:44:18.073');
INSERT INTO users (id, name, email, image_name, password, created_at, updated_at) VALUES(7,'for user like','7@progate.com','/image/users/default_user.jpg','password','2021-04-23 11:44:18.073','2021-04-23 11:44:18.073');
INSERT INTO users (id, name, email, image_name, password, created_at, updated_at) VALUES(8,'for create post','8@progate.com','/image/users/default_user.jpg','password','2021-04-23 11:44:18.073','2021-04-23 11:44:18.073');
INSERT INTO users (id, name, email, image_name, password, created_at, updated_at) VALUES(9,'for post show','9@progate.com','/image/users/default_user.jpg','password','2021-04-23 11:44:18.073','2021-04-23 11:44:18.073');
INSERT INTO users (id, name, email, image_name, password, created_at, updated_at) VALUES(10,'for like post','10@progate.com','/image/users/default_user.jpg','password','2021-04-23 11:44:18.073','2021-04-23 11:44:18.073');
-- posts
